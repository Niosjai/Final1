...
def handle_tutorial(message):
    ...
    video_chat_id = -1001983462200  # The ID of the chat from which the video will be forwarded
    video_message_id = 312  # The ID of the specific video message to forward
    
    # Forward the message from the specified chat to the user
